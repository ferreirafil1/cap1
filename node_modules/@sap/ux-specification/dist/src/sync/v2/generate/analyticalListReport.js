...
function generateAnalyticalListReportSchemaV2(genericSchema, entityTypeName, entityTypes, manifest, fragments, logger) {
    ...
    tableDefinitionResponsive['properties']['toolBar'].$ref = common_1.DEFINITION_LINK_PREFIX + 'ToolBar<LineItems>';
    ...
    tableDefinitionGrid['properties']['toolBar'].$ref = common_1.DEFINITION_LINK_PREFIX + 'ToolBar<LineItems>';
    ...
    tableDefinitionAnalytical['properties']['toolBar'].$ref = common_1.DEFINITION_LINK_PREFIX + 'ToolBar<LineItems>';
