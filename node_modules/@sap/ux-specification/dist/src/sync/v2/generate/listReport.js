...
function generateListReportSchemaV2(genericSchema, entityTypeName, entityTypes, manifest, fragments, logger) {
    ...
    appSchema['properties']['table']['anyOf']['0']['$ref'] =
        common_1.DEFINITION_LINK_PREFIX + 'ResponsiveTableWithMultiSelect<LineItems>';
    appSchema['properties']['table']['anyOf']['1']['$ref'] =
        common_1.DEFINITION_LINK_PREFIX + 'ResponsiveTableWithInlineDelete<LineItems>';
    appSchema['properties']['table']['anyOf']['2']['$ref'] = common_1.DEFINITION_LINK_PREFIX + 'TreeTable<LineItems>';
    appSchema['properties']['table']['anyOf']['3']['$ref'] = common_1.DEFINITION_LINK_PREFIX + 'AnalyticalTable<LineItems>';
    appSchema['properties']['table']['anyOf']['4']['$ref'] = common_1.DEFINITION_LINK_PREFIX + 'GridTable<LineItems>';
    ...
    const lrToolBar = common_1.DEFINITION_LINK_PREFIX + 'ToolBar<LineItems>';
    appSchema['definitions']['ResponsiveTableWithMultiSelect<LineItems>'] = responsiveTableMultiSelect;
    appSchema['definitions']['ResponsiveTableWithMultiSelect<LineItems>'].properties.toolBar.$ref = lrToolBar;
    appSchema['definitions']['ResponsiveTableWithInlineDelete<LineItems>'] = responsiveTableInlineDelete;
    appSchema['definitions']['ResponsiveTableWithInlineDelete<LineItems>'].properties.toolBar.$ref = lrToolBar;
    appSchema['definitions']['TreeTable<LineItems>'] = treeTableDefinition;
    appSchema['definitions']['TreeTable<LineItems>'].properties.toolBar.$ref = lrToolBar;
    appSchema['definitions']['AnalyticalTable<LineItems>'] = analyticalTableDefinition;
    appSchema['definitions']['AnalyticalTable<LineItems>'].properties.toolBar.$ref = lrToolBar;
    appSchema['definitions']['GridTable<LineItems>'] = gridTableDefinition;
    appSchema['definitions']['GridTable<LineItems>'].properties.toolBar.$ref = lrToolBar;
    ...
    if (!entityType) {
        ...
        const pageKeys = [];
        const v2Page = import_1.findListReportPage(manifest[v2_1.ManifestSection.generic].pages, pageKeys);
        if (!v2Page) {
            v2_1.log(logger, {
                severity: "error" /* Error */,
