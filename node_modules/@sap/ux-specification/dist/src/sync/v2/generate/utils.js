...
function addLineItemsType(appSchema, lineItemAnnotation, entityType, lineItemId, customColumnRef) {
    ...
    if (lineItemAnnotation) {
        ...
        lineItemAnnotation.forEach((lineItemRecord) => {
            if (lineItemRecord.$Type === 'com.sap.vocabularies.UI.v1.DataFieldForIntentBasedNavigation' ||
                (lineItemRecord.$Type === 'com.sap.vocabularies.UI.v1.DataFieldForAction' &&
...
/**
 * Apply post-processing rules to a list of properties of the given schema section
