...
exports.getSmartTableControlId = (baseId, idBreadcrumbs, breadcrumbs, controlType) => {
...
function importCreateParameters(manifestSection) {
    ...
    let configPart = {};
    if (manifestSection) {
        configPart = JSON.parse(JSON.stringify(manifestSection));
    }
    return configPart;
}
...
function importType(manifestValue) {
    return manifestValue ? manifestValue : v2_1.TableTypeV2.ResponsiveTable;
}
...
__decorate([
    decoration_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys) + '/quickVariantSelection'
        }
    }),
    decoration_1.validity({
        since: '1.48.0'
    ...
    decoration_1.syncRule({
        manifest: {
            ...
            export: (manifestSection, configObject) => {
                const quickVariantSelectionX = JSON.parse(JSON.stringify(configObject['quickVariantSelectionX']));
                manifestSection['quickVariantSelectionX'] = quickVariantSelectionX;
                if (quickVariantSelectionX['variants']) {
                    for (const variant in quickVariantSelectionX['variants']) {
                        const variantConfig = quickVariantSelectionX['variants'][variant];
                        ...
                        manifestSection['quickVariantSelectionX']['variants'][variant] = variantConfig;
                    }
                }
            }
        }
...
], TableALP.prototype, "filterDefaultsFromSelectionVariant", void 0);
__decorate([
    decoration_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys)
