...
function importDateSettings(manifestSection) {
    ...
    const configPart = JSON.parse(JSON.stringify(manifestSection));
    // converted CSV format to array of strings
    if (typeof manifestSection['selectedValues'] === 'string') {
        configPart.selectedValues = manifestSection['selectedValues'].split(',');
    }
    if (manifestSection['fields']) {
        for (const propertyKey in manifestSection['fields']) {
            configPart.fields[propertyKey] = manifestSection['fields'][propertyKey];
            const selectedValues = manifestSection['fields'][propertyKey].selectedValues;
            if (typeof selectedValues === 'string') {
                configPart.fields[propertyKey].selectedValues = selectedValues.split(',');
            }
            for (const filterKey in manifestSection['fields'][propertyKey].filter) {
                const filterValue = manifestSection['fields'][propertyKey].filter[filterKey];
        ...
        manifest: {
            path: (pageKeys, pageType) => {
                if (pageType === common_2.PageType.OverviewPage) {
                    return application_1.getOVPsettingPath() + '/filterSettings/dateSettings';
                }
                else {
                    return application_1.getAppSettingPathV2(pageKeys) + '/filterSettings/dateSettings';
                }
            }
        }
    }),
...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys) + '/filterSettings/dateSettings',
...
], FilterBar.prototype, "smartVariantManagement", void 0);
__decorate([
    decorators_1.syncRule({
        flex: {
...
], FilterBar.prototype, "liveMode", void 0);
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys)
...
], FilterBar.prototype, "variantManagementHidden", void 0);
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys)
...
], FilterBar.prototype, "subTitleIfVariantMgmtHidden", void 0);
__decorate([
    decorators_1.syncRule({
        manifest: {
        ...
        hasDistinctDefinition: true
    }),
    decorators_1.validity({
        since: '1.77.0'
    })
], FilterBar.prototype, "dateSettings", void 0);
__decorate([
    decorators_1.syncRule({
        flex: {
            controlId: decoration_1.buildControlIdFromParent,
...
], FilterBar.prototype, "showClearOnFB", void 0);
__decorate([
    decorators_1.syncRule({
        flex: {
            controlId: decoration_1.buildControlIdFromParent,
...
], FilterBar.prototype, "showFilterConfiguration", void 0);
__decorate([
    decorators_1.syncRule({
        flex: {
            controlId: decoration_1.buildControlIdFromParent,
...
], FilterBar.prototype, "showRestoreOnFB", void 0);
exports.FilterBar = FilterBar;
class AnalyticalListPageFilterBar extends FilterBar {
}
__decorate([
    decorators_1.syncRule({
        manifest: {
