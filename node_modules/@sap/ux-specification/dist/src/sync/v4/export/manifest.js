    ...
    for (const id in pages) {
        ...
        if (page.pageType !== v4_1.PageTypeV4.CustomPage) {
            ...
            target = Object.assign(Object.assign({}, target), {
                type: 'Component',
                id: page.view.id,
                name: `${v4_1.FE_TEMPLATE_V4_CUSTOM_PAGE}`,
                options: {
                    settings: {
                        viewName: page.view.name
                    }
        ...
        if ((_h = (_g = target === null || target === void 0 ? void 0 : target.options) === null || _g === void 0 ? void 0 : _g.settings) === null || _h === void 0 ? void 0 : _h.navigation) {
