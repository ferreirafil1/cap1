...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageName, manifest, sectionId) => application_1.getTableSettingsPathForOP(pageName, manifest, sectionId),
            export: (manifestSection, configObject, key, manifestKey) => {
                Table_1.exportPersonalizationProperty(manifestSection, configObject, key, manifestKey);
            },
            delete: (manifestSection, configObject, key, manifestKey) => {
                Table_1.deletePersonalizationProperty(manifestSection, manifestKey);
            }
        }
    })
...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageName, manifest, sectionId) => application_1.getTableSettingsPathForOP(pageName, manifest, sectionId) + '/quickVariantSelection'
        }
    })
