...
*/
export type ServiceVersion = AnnotationTerm<Edm.Int32>;

// Term
/**
  0 for first schema version within a service version, incremented when schema changes compatibly
*/
export type ServiceSchemaVersion = AnnotationTerm<Edm.Int32>;
...
*/
export type TextFor = AnnotationTerm<Edm.PropertyPath>;
...
// EnumType
export const enum TextFormatType {
	/**
...
*/
export type Timezone = AnnotationTerm<PropertyAnnotationValue<Edm.String>>;
...
*/
export type SemanticObjectMapping = AnnotationTerm<SemanticObjectMappingTypeTypes[]>;
...
*/
export type FilterExpressionRestrictions = AnnotationTerm<FilterExpressionRestrictionTypeTypes[]>;
...
/**
  Control state of a property
*/
export const enum FieldControlType {
	/**
...
/**
  ...
*/
export type Application = AnnotationTerm<ApplicationTypeTypes>;
...
/**
  ...
*/
export type Timestamp = AnnotationTerm<Edm.DateTimeOffset>;
...
*/
export type ErrorResolution = AnnotationTerm<ErrorResolutionTypeTypes>;
...
*/
export type Messages = AnnotationTerm<Edm.ComplexType[]>;
...
*/
export type WeakReferentialConstraint = AnnotationTerm<WeakReferentialConstraintTypeTypes>;

// ComplexType
export type WeakReferentialConstraintType = ComplexType & {
...
// ComplexType
export type ForeignKeyType = ComplexType & {
...
*/
export type ValueList = AnnotationTerm<ValueListTypeTypes>;
...
*/
export type ValueListForValidation = AnnotationTerm<PropertyAnnotationValue<Edm.String>>;
...
*/
export type ValueListMapping = AnnotationTerm<ValueListMappingTypeTypes>;
...
// ComplexType
export type ValueListParameterIn = ComplexType &
	Omit<ValueListParameter, "$Type"> & {
...
// ComplexType
export type ValueListParameterConstant = ComplexType &
	Omit<ValueListParameter, "$Type"> & {
...
// ComplexType
export type ValueListParameterInOut = ComplexType &
	Omit<ValueListParameter, "$Type"> & {
...
// ComplexType
export type ValueListParameterOut = ComplexType &
	Omit<ValueListParameter, "$Type"> & {
...
*/
export type ValueListParameterDisplayOnly = ComplexType &
	Omit<ValueListParameter, "$Type"> & {
...
*/
export type ValueListParameterFilterOnly = ComplexType &
	Omit<ValueListParameter, "$Type"> & {
...
*/
export type DraftRoot = AnnotationTerm<DraftRootTypeTypes>;

// ComplexType
export type DraftRootType = ComplexType &
	Omit<DraftNodeType, "$Type"> & {
...
*/
export type DraftNode = AnnotationTerm<DraftNodeTypeTypes>;
...
*/
export type EditableFieldFor = AnnotationTerm<Edm.PropertyPath>;
...
*/
export type SemanticKey = AnnotationTerm<Edm.PropertyPath[]>;

// Term
/**
  Describes side-effects of modification operations
*/
export type SideEffects = AnnotationTerm<SideEffectsTypeTypes>;
...
*/
export type FilterDefaultValue = AnnotationTerm<Edm.PrimitiveType>;

// Term
/**
  A default upper limit for the property to be used in 'less than or equal' filter expressions.
*/
export type FilterDefaultValueHigh = AnnotationTerm<Edm.PrimitiveType>;
...
*/
export type SortOrder = AnnotationTerm<SortOrderTypeTypes[]>;
...
/**
  Creation timestamp
*/
export type CreatedAt = AnnotationTerm<Edm.DateTimeOffset>;
...
*/
export type ChangedAt = AnnotationTerm<Edm.DateTimeOffset>;
...
*/
export type mediaUploadLink = AnnotationTerm<PropertyAnnotationValue<Edm.String>>;
...
export type SemanticObjectMappingTypeTypes = AnnotationTerm<SemanticObjectMappingType>;
export type FilterExpressionRestrictionTypeTypes = AnnotationTerm<FilterExpressionRestrictionType>;
export type ApplicationTypeTypes = AnnotationTerm<ApplicationType>;
export type ErrorResolutionTypeTypes = AnnotationTerm<ErrorResolutionType>;
export type IntervalTypeTypes = AnnotationTerm<IntervalType>;
export type WeakReferentialConstraintTypeTypes = AnnotationTerm<WeakReferentialConstraintType>;
export type ForeignKeyTypeTypes = AnnotationTerm<ForeignKeyType>;
export type ValueListTypeTypes = AnnotationTerm<ValueListType>;
export type ValueListMappingTypeTypes = AnnotationTerm<ValueListMappingType>;
export type ValueListParameterTypes = AnnotationTerm<
	| ValueListParameterInTypes
	| ValueListParameterConstantTypes
	| ValueListParameterInOutTypes
	| ValueListParameterOutTypes
	| ValueListParameterDisplayOnlyTypes
	| ValueListParameterFilterOnlyTypes
>;
export type ValueListParameterInTypes = AnnotationTerm<ValueListParameterIn>;
export type ValueListParameterConstantTypes = AnnotationTerm<ValueListParameterConstant>;
export type ValueListParameterInOutTypes = AnnotationTerm<ValueListParameterInOut>;
export type ValueListParameterOutTypes = AnnotationTerm<ValueListParameterOut>;
export type ValueListParameterDisplayOnlyTypes = AnnotationTerm<ValueListParameterDisplayOnly>;
export type ValueListParameterFilterOnlyTypes = AnnotationTerm<ValueListParameterFilterOnly>;
export type DraftRootTypeTypes = AnnotationTerm<DraftRootType>;
export type DraftNodeTypeTypes = AnnotationTerm<DraftNodeType | DraftRootTypeTypes>;
export type SideEffectsTypeTypes = AnnotationTerm<SideEffectsType>;
export type SortOrderTypeTypes = AnnotationTerm<SortOrderType>;
