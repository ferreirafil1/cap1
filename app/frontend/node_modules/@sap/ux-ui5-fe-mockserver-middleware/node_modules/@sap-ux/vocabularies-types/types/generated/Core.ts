...
// Term
/**
  An annotation with this term may target a type, but only in order to allow dynamic expressions [[OData-CSDL, section 14.4](https://docs.oasis-open.org/odata/odata-csdl-xml/v4.01/cos01/odata-csdl-xml-v4.01-cos01.html#sec_DynamicExpression)] that depend on properties of the type
*/
export type AppliesToTypeIfDynamic = AnnotationTerm<PropertyAnnotationValue<Tag>>;

// Term
/**
  The target path of an annotation with this term must start with an entity container or the annotation must be embedded within an entity container, entity set or singleton
*/
export type AppliesViaContainer = AnnotationTerm<PropertyAnnotationValue<Tag>>;
...
// Term
/**
  The content disposition of a binary or stream property or term
*/
...
export const enum CoreAnnotationTerms {
	...
	AppliesToTypeIfDynamic = "Org.OData.Core.V1.AppliesToTypeIfDynamic",
