...
exports.getAppSettingPathV2 = (pageKeys) => {
    return `${common_1.ManifestSection.generic}/pages/${pageKeys[0]}/component/settings`;
};
exports.getTableSettingPathV2 = (pageKeys) => {
    const path = exports.getAppSettingPathV2(pageKeys);
    return path + '/tableSettings';
};
exports.getChartSettingPathV2 = (pageKeys) => {
    const path = exports.getAppSettingPathV2(pageKeys);
...
exports.getOVPsettingPath = () => {
    return common_1.ManifestSection.ovp;
};
exports.getCardSettingsPath = (cardKey) => {
    const pathParts = [common_1.ManifestSection.ovp + '/cards'];
...
exports.getGlobalSettingsPath = (cardKey) => {
    const pathParts = [common_1.ManifestSection.ovp];
    cardKey.forEach((block) => {
        pathParts.push(block);
    });
    pathParts.pop();
...
exports.getKPISettingsPath = (pageKeys, manifest, kpiKey) => {
    return `${common_1.ManifestSection.generic}/pages/${pageKeys[0]}/component/settings/keyPerformanceIndicators/${kpiKey}`;
};
// This corresponds to List Report and Object page global settings
exports.getAppRootSettingOBJPath = (pageKeys) => {
    const pathParts = [common_1.ManifestSection.generic];
...
exports.getAppSettingOBJsectionPathV2 = (pageKeys, manifest, sectionId) => {
    const pathParts = [];
    pathParts.push(exports.getAppRootSettingOBJPath(pageKeys));
...
exports.getTableSettingsOBJsectionPathV2 = (pageKeys, manifest, sectionId) => {
    const path = exports.getAppSettingOBJsectionPathV2(pageKeys, {}, sectionId);
    return path + '/tableSettings';
};
exports.getChartSettingsOBJsectionPathV2 = (pageKeys, manifest, sectionId) => {
    const path = exports.getAppSettingOBJsectionPathV2(pageKeys, {}, sectionId);
    return path + '/chartSettings';
};
...
exports.getObjectPageCustomSectionPath = (pageName, manifest, sectionId, ...pathParts) => {
    const separator = '|';
