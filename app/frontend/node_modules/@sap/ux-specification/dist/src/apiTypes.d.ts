...
export interface ExtensionLogger {
    info: (message: string, ...meta: (object | string | number)[]) => void;
    warning: (message: string, ...meta: (object | string | number)[]) => void;
    error: (message: string, ...meta: (object | string | number)[]) => void;
}
/**
