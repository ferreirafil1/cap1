...
function readFragmentFile(fragmentName, fragmentFiles, manifestPart, appId) {
    ...
    for (const key in fragmentFiles) {
        if (fragmentFiles[key].dataSourceUri.endsWith(extensionPath)) {
            fragmentData = {
                manifestPart,
                fragmentFileContent: fragmentFiles[key].fileContent
            };
            break;
        }
    }
...
function readControlConfigurationExtension(manifest, target, targetSegment, appId, fragmentFiles) {
    ...
    for (const pageKey in targets) {
        if (pageKey === target) {
            ...
            if (targetSettings) {
                const controlConfiguration = targetSettings.controlConfiguration;
                if (controlConfiguration) {
                    for (const configKey in controlConfiguration) {
                        const segments = controlConfiguration[configKey][targetSegment];
                        if (segments) {
                            for (const key in segments) {
                                if (segments[key]['template']) {
                                    //extension as part of controlConfiguration
                                    const fragment = readFragmentFile(segments[key]['template'], fragmentFiles, segments[key], appId);
                                    if (fragment) {
    ...
    for (const pageKey in targets) {
        if (pageKey === target) {
            ...
            if (targetSettings) {
                ...
                const configBasedFacets = (_b = (_a = targetSettings.controlConfiguration) === null || _a === void 0 ? void 0 : _a['@com.sap.vocabularies.UI.v1.HeaderFacets']) === null || _b === void 0 ? void 0 : _b.facets;
                const contentBasedFacets = (_d = (_c = targetSettings.content) === null || _c === void 0 ? void 0 : _c.header) === null || _d === void 0 ? void 0 : _d.facets;
    ...
    for (const pageKey in targets) {
        if (pageKey === target) {
            ...
            if (targetSettings) {
                ...
                const contentBasedSections = (_b = (_a = targetSettings.content) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.sections;
                const configBasedSections = (_d = (_c = targetSettings.controlConfiguration) === null || _c === void 0 ? void 0 : _c['@com.sap.vocabularies.UI.v1.Facets']) === null || _d === void 0 ? void 0 : _d.sections;
