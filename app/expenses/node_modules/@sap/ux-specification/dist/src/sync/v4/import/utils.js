...
function transferSettingsOfObject(object, manifest, jsonSchema, pageName, sectionId) {
    ...
    for (const key in jsonSchema['properties']) {
        const syncRule = decorators_1.getReflectMetadata(object, key);
        const path = syncRule.manifest.path([pageName], {}, sectionId);
        manifestSection = utils_1.getManifestSectionByPathV4(manifest, path, sectionId);
