...
async function getGenericSchemas(templateType, fioriElementsVersion) {
    ...
    switch (templateType) {
        ...
        case utils_1.TemplateType.OverviewPageV2:
            ...
            break;
        case utils_1.TemplateType.FormPageV4:
            schemaTypes.push(common_1.SchemaType.ObjectPage);
            break;
        default:
            break;
    }
 ...
 */
function generateObjectPageSchemasV2(genericSchemas, manifest, oDataServiceAVT, appSchemas, fragments, logger) {
    ...
    for (const page in allPages) {
        ...
        appSchemas[schemaFile.filename] = generate_1.generateObjectPageSchemaV2(genericSchemas[genericSchemaFile.filename], entityTypeName, oDataServiceAVT, manifest, fragments, logger);
    }
}
/**
 ...
 * @param {ExtensionLogger} logger - Logger class for logging messages
 */
function generateObjectPageSchemasV4(genericSchemas, manifest, oDataServiceAVT, appSchemas, logger) {
    var _a;
    ...
    for (const page in pages) {
        ...
        const entityTypeName = entitySet && (entitySet === null || entitySet === void 0 ? void 0 : entitySet.entityType) && ((_a = entitySet === null || entitySet === void 0 ? void 0 : entitySet.entityType) === null || _a === void 0 ? void 0 : _a.name);
        const schemaFile = utils_1.getSchemaFilePath(common_1.SchemaType.ObjectPage, (entitySet === null || entitySet === void 0 ? void 0 : entitySet.name) || entitySetName);
        const genericSchemaFile = utils_1.getSchemaFilePath(common_1.SchemaType.ObjectPage);
 ...
 * @param {ExtensionLogger} logger - Logger class for logging messages
 */
function generateAppSchemasV2(genericSchemas, uiEntityTypes, oDataServiceAVT, manifest, templateType, fragments, logger) {
    ...
    if (templateType === utils_1.TemplateType.ListReportObjectPageV2 && uiEntityTypes) {
        ...
        for (const page in allPages) {
            ...
            appSchemas[schemaFile.filename] = generate_1.generateListReportSchemaV2(genericSchemas[genericSchemaFile.filename], entityTypeName, entityTypes, manifest, fragments, logger);
        }
        /*--- Object Pages ----*/
        generateObjectPageSchemasV2(genericSchemas, manifest, oDataServiceAVT, appSchemas, fragments, logger);
    }
        ...
        for (const page in allPages) {
            ...
            appSchemas[schemaFile.filename] = generate_1.generateAnalyticalListReportSchemaV2(genericSchemas[genericSchemaFile.filename], entityTypeName, entityTypes, manifest, fragments, logger);
        }
        /*--- Object Pages ----*/
        generateObjectPageSchemasV2(genericSchemas, manifest, oDataServiceAVT, appSchemas, fragments, logger);
    }
 ...
 * @param {ExtensionLogger} logger - Logger class for logging messages
 */
function generateAppSchemasV4(genericSchemas, uiEntityTypes, oDataServiceAVT, manifest, templateType, logger) {
    const appSchemas = {};
    if (uiEntityTypes) {
        if (templateType === utils_1.TemplateType.ListReportObjectPageV4) {
            ...
            for (const page in pages) {
                ...
                const schemaFile = utils_1.getSchemaFilePath(common_1.SchemaType.ListReport, (entitySet === null || entitySet === void 0 ? void 0 : entitySet.name) || entitySetName);
                const genericSchemaFile = utils_1.getSchemaFilePath(common_1.SchemaType.ListReport);
                appSchemas[schemaFile.filename] = generate_2.generateListReportSchemaV4(genericSchemas[genericSchemaFile.filename], entityTypeName, oDataServiceAVT, logger);
            }
            /*--- Object Pages ----*/
            ...
            /*--- Object Pages ----*/
            generateObjectPageSchemasV4(genericSchemas, manifest, oDataServiceAVT, appSchemas, logger);
        }
        else if (templateType === utils_1.TemplateType.FormPageV4) {
            /*--- Form Page ----*/
            generateObjectPageSchemasV4(genericSchemas, manifest, oDataServiceAVT, appSchemas);
        }
    }
 ...
 * @param {ExtensionLogger} logger - Logger class for logging messages
 */
async function generateAppSchemas(uiEntityTypes, fioriElementsVersion, oDataServiceAVT, manifest, templateType, fragments, logger) {
    ...
    if (fioriElementsVersion === common_1.FioriElementsVersion.v4) {
        return generateAppSchemasV4(genericSchemas, uiEntityTypes, oDataServiceAVT, manifest, templateType, logger);
    }
    else {
        return generateAppSchemasV2(genericSchemas, uiEntityTypes, oDataServiceAVT, manifest, templateType, fragments, logger);
    }
}
/**
 ...
 */
function importConfigs(manifest, flex, appSchemas, oDataServiceAVT, templateType, fragments) {
    let provider;
    const files = [];
    switch (templateType) {
        case utils_1.TemplateType.ListReportObjectPageV2:
...
async function importProjectSchema(importProjectParameters) {
    ...
    i18n_1.initI18n();
    let files = [];
    const { manifest, annotations, fragments, logger } = importProjectParameters;
    ...
    const appSchemas = await generateAppSchemas(uiEntityTypes, fioriElementsVersion, service, manifest, templateType, fragments, logger);
...
async function importProjectSchemaAndConfig(importProjectParameters) {
    ...
    const appSchemas = await generateAppSchemas(uiEntityTypes, fioriElementsVersion, oDataServiceAVT, manifest, templateType, fragments, logger);
